                           ...
                           progressBlock:(BADownloadProgressBlock)progressBlock
{
    ...
    [BANetManagerShare.sessionManager.requestSerializer setValue:[UserDefaultsUtils valueWithKey:@"access_token"] forHTTPHeaderField:@"accessToken"];
    [BANetManagerShare.sessionManager.requestSerializer setValue:[NSString stringWithFormat:@"%@",[[[NSBundle mainBundle]infoDictionary]objectForKey:@"CFBundleShortVersionString"]] forHTTPHeaderField:@"version"];
    [BANetManagerShare.sessionManager.requestSerializer setValue:@"4" forHTTPHeaderField:@"clientType"];
    [BANetManagerShare.sessionManager.requestSerializer setValue:[OpenUDID value] forHTTPHeaderField:@"UUID"];
                                 ...
                                 progressBlock:(BADownloadProgressBlock)progressBlock
{
    ...
    return [self ba_requestWithType:BAHttpRequestTypeGet isNeedCache:entity.isNeedCache urlString:[NSString stringWithFormat:@"%@%@",SERVER_HOST,entity.urlString]
                                  ...
                                  progressBlock:(BADownloadProgressBlock)progressBlock
{
    ...
    return [self ba_requestWithType:BAHttpRequestTypePost isNeedCache:entity.isNeedCache urlString:[NSString stringWithFormat:@"%@%@",SERVER_HOST,entity.urlString] parameters:entity.parameters successBlock:successBlock failureBlock:failureBlock progressBlock:progressBlock];
}
                                 ...
                                 progressBlock:(BADownloadProgressBlock)progressBlock
{
    ...
    return [self ba_requestWithType:BAHttpRequestTypePut isNeedCache:NO urlString:[NSString stringWithFormat:@"%@%@",SERVER_HOST,entity.urlString] parameters:entity.parameters successBlock:successBlock failureBlock:failureBlock progressBlock:progressBlock];
}
                                    ...
                                    progressBlock:(BADownloadProgressBlock)progressBlock
{
    ...
    return [self ba_requestWithType:BAHttpRequestTypeDelete isNeedCache:NO urlString:[NSString stringWithFormat:@"%@%@",SERVER_HOST,entity.urlString] parameters:entity.parameters successBlock:successBlock failureBlock:failureBlock progressBlock:progressBlock];
}
