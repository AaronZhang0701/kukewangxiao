...
#import "ZMBaseCollectionViewController.h"
#import <MJRefresh/MJRefresh.h>
#import "PLVDownloadManagerViewController.h"
@interface ZMBaseCollectionViewController ()<UICollectionViewDataSource, UICollectionViewDelegate,ZMEmptyDataSetSource,ZMEmptyDataSetDelegate>
...
@implementation ZMBaseCollectionViewController
...
- (UICollectionView *)collectionView
{
    if (!_collectionView)
    {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0 , 0 , screenWidth(), screenHeight()-UI_navBar_Height) collectionViewLayout: self.flowlayout];
...
-(void)initRefresh{
    ...
    self.collectionView.tg_header = [TGRefreshOC  refreshWithTarget:self action:@selector(headerRefresh) config:nil];
    self.collectionView.tg_header.fadeinTime = 2;
    self.collectionView.tg_header.fadeoutTime = 5;
    //设置上拉
...
- (void)endWaterDropRefreshWithHeaderHidden{
    [self.collectionView.tg_header endRefreshing];
}
