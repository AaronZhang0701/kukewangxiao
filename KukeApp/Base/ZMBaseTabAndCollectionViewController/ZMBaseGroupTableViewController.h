//
//  ZMBaseGroupTableViewController.h
//  KukeApp
//
...
typedef NS_ENUM(NSInteger, GLQTableViewLoadingViewType) {
    GLQTableViewLoadingViewTypeDefault = 0,//默认菊花加载动画
    GLQTableViewLoadingViewTypeGif,
    GLQTableViewLoadingViewTypeCustom
};
typedef NS_ENUM(NSInteger, GLQTableViewFailLoadViewType) {
    GLQTableViewFailLoadViewTypeDefault = 0,//默认数据加载失败
    GLQTableViewFailLoadViewTypeNoData,
    GLQTableViewFailLoadViewTypeGif,
    GLQTableViewFailLoadViewTypeCustom
};

@interface ZMBaseGroupTableViewController : ZMBaseViewController<NoDataTipsDelegate>
