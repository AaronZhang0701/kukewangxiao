...
@interface ZMBaseTableViewController ()<ZMEmptyDataSetSource,ZMEmptyDataSetDelegate,UITableViewDataSource,UITableViewDelegate>
...
- (UITableView *)tableView {
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth,screenHeight()-UI_navBar_Height) style:UITableViewStylePlain];
