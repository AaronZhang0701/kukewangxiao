...
+ (void)initialize
{
    ...
    [navBar setTintColor:CTitleColor];
    [navBar setTitleTextAttributes:@{NSForegroundColorAttributeName :CTitleColor, NSFontAttributeName : [UIFont systemFontOfSize:18]}];
...
//    [navBar setShadowImage:[UIImage new]];//去掉阴影线
    ...
    [UINavigationBar appearance].backIndicatorTransitionMaskImage = [UIImage imageNamed:@"导航栏返回"];
    [UINavigationBar appearance].backIndicatorImage = [UIImage imageNamed:@"导航栏返回"];
