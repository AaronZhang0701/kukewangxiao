//
//  UICollectionView+EmptyDataSet.m
//  KukeApp
//
//  Created by 库课 on 2019/8/21.
...
@implementation UICollectionView (EmptyDataSet)
...
{
    objc_setAssociatedObject(self, &block1, loadingClick, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
-(void (^)())loadingClick
{
    return objc_getAssociatedObject(self, &block1);
}
...
- (UIView *)customViewForEmptyDataSet:(UIScrollView *)scrollView
{
    if (self.loading) {
        ...
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake((screenWidth()-200)/2, (self.height-(screenHeight()-self.height)-380-self.origin.y)/2, 200, 200)];//        imageView.center = self.center;
...
//        }];
        ...
        imageView.image = [UIImage animatedImageWithImages:tempArr duration:1];
