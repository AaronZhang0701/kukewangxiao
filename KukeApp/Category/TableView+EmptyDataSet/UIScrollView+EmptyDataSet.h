...
@protocol ZMEmptyDataSetSource;
@protocol ZMEmptyDataSetDelegate;
...
@property (nonatomic, weak) IBOutlet id <ZMEmptyDataSetSource> emptyDataSetSource;
/** The empty datasets delegate. */
@property (nonatomic, weak) IBOutlet id <ZMEmptyDataSetDelegate> emptyDataSetDelegate;
 ...
 */
@protocol ZMEmptyDataSetSource <NSObject>
@optional
 ...
 */
@protocol ZMEmptyDataSetDelegate <NSObject>
@optional
