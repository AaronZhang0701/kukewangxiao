...
static NSString * const orderIdKey = @"sn_orderID";
...
- (void)paymentQueue:(SKPaymentQueue *)queue updatedTransactions:(nonnull NSArray<SKPaymentTransaction *> *)transactions {
    ...
    [BaseTools showProgressMessage:@"购买中，请耐心等待..."];
...
-(void)saveReceipt {
    ...
    NSString *fileName = [NSString zm_UUID];
...
-(void)sendAppStoreRequestBuyPlist:(NSString *)plistPath {
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [dic objectForKey:receiptKey],          @"receipt",
//                                   [dic objectForKey:dateKey],             dateKey,
//                                   [dic objectForKey:userIdKey],           userIdKey,
                                   [dic objectForKey:orderIdKey],           @"order_sn",
                                   nil];

//    NSString *receiptBase64 = [receipt base64EncodedStringWithOptions:NSDataBase64EncodingEndLineWithCarriageReturn];
    
//    NSMutableDictionary *parmDic = [NSMutableDictionary dictionary];
//    [parmDic setObject:self.sn_orderID  forKey:@"order_sn"];
//    [parmDic setObject:self.receipt  forKey:@"receipt"];
//
    [ZMNetworkHelper POST:@"/order/iphone_recharge_validata" parameters:params cache:NO responseCache:^(id responseCache) {
