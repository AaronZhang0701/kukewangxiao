...
@interface PLVDownloadProcessingViewController ()<UITableViewDataSource, UITableViewDelegate, UIAlertViewDelegate,ZMEmptyDataSetSource,ZMEmptyDataSetDelegate>
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"PLVDownloadProcessingCell" bundle:nil] forCellReuseIdentifier:@"PLVDownloadProcessingCell"];
        // 删除单元格分隔线的一个小技巧
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"温馨提示" message:@"您确定要删除该视频吗？" preferredStyle:UIAlertControllerStyleAlert];
