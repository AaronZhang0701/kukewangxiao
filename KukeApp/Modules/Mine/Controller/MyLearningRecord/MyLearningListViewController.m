//
//  MyLearningListViewController.m
//  KukeApp
//
...
@interface MyLearningListViewController ()<ZMTabPagerBarDataSource,ZMTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate>
@property (nonatomic, weak) ZMTabPagerBar *tabBar;
@property (nonatomic, weak) TYPagerController *pagerController;
@property (nonatomic, strong) NSArray *datas;
@property (nonatomic, strong)MylearningListChildrenVC *VC1;
@property (nonatomic, strong)MylearningListChildrenVC *VC2;
@end

@implementation MyLearningListViewController
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    ...
    switch (index) {
            case 0:{
                MylearningListChildrenVC *VC = [[MylearningListChildrenVC alloc]init];
                VC.cate_id = @"2";
                self.VC1 = VC;
                return VC;
            };
