...
- (void)initialize {
    ...
    _selectedItemTitleFont = [UIFont systemFontOfSize:13];
    _unSelectedItemTitleFont = [UIFont systemFontOfSize:13];
    _itemTitleFont = [UIFont systemFontOfSize:13];
    _trackerHeight = 1.0;
...
- (void)setupSubViews {
    ...
    dividingLine.backgroundColor = CBackgroundColor;
