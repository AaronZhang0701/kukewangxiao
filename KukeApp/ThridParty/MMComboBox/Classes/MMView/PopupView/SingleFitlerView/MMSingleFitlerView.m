...
- (id)initWithItem:(MMItem *)item {
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor whiteColor];
         [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dismiss) name:@"BoxClose" object:nil];
    }
    return self;
}
...
- (void)popupViewFromSourceFrame:(CGRect)frame completion:(void (^ __nullable)(void))completion {
    ...
    rootView.backgroundColor = [UIColor colorWithRed:0.00f green:0.00f blue:0.00f alpha:0.75f];
    self.sourceFrame = frame;
    CGFloat top =  CGRectGetMaxY(self.sourceFrame)+UI_navBar_Height+ 60;
    ...
    [UIView animateWithDuration:AnimationDuration animations:^{
        ...
        self.bottomView.backgroundColor = [UIColor colorWithRed:0.00f green:0.00f blue:0.00f alpha:0.75f];
