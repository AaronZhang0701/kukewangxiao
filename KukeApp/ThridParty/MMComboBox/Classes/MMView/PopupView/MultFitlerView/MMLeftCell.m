...
- (void)setItem:(MMItem *)item {
    ...
    self.backgroundColor = item.isSelected?CNavBgColor:[UIColor colorWithHexString:UnselectedBGColor];
    self.infoLabel.textColor = item.isSelected?CNavBgColor:[UIColor blackColor];
}
- (void)layoutSubviews {
