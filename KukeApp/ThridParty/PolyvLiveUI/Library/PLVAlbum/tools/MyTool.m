...
+ (void)leftBarButtonItemAction:(SEL)action target:(UIViewController*)vc {
    ...
    UIBarButtonItem *leftItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"导航栏返回"] style:UIBarButtonItemStylePlain target:vc action:action];
...
+ (void)rightBarButtonItem:(NSString*)imgStr action:(SEL)action target:(UIViewController*)vc {
    ...
    rightItem.tintColor = CNavBgColor;
