...
@interface ACSelectMediaView ()<UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, TZImagePickerControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
//            if ([model.mediaURL isKindOfClass:[UIImage class]]) {
//                photo.image = model.mediaURL;
//            }else if ([model.mediaURL isKindOfClass:[NSString class]]){
//                photo.url = [NSURL URLWithString:model.mediaURL];
//            }else if ([model.mediaURL isKindOfClass:[NSURL class]] ){
//                photo.url = model.mediaURL;
//            }
