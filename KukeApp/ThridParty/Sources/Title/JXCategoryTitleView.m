...
- (UILabel *)lineLab{
    if (!_lineLab) {
        _lineLab = [[UILabel alloc]initWithFrame:CGRectMake(0, self.frame.size.height-1, screenWidth(), 1)];
        _lineLab.backgroundColor = CBackgroundColor;
    }
    return _lineLab;
}
