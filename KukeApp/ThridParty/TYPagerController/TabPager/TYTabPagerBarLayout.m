...
//            fromCell.transform = CGAffineTransformMakeScale(_selectFontScale, _selectFontScale);
            fromCell.titleLabel1.font = _normalTextFont;
            fromCell.titleLabel1.textColor = _normalTextColor;
            fromCell.transform = CGAffineTransformMakeScale(_selectFontScale, _selectFontScale);
        }
        if (toCell) {
...
//            toCell.transform = CGAffineTransformIdentity;
            toCell.titleLabel1.font = _normalTextFont;
            toCell.titleLabel1.textColor = _selectedTextColor ? _selectedTextColor : _normalTextColor;
            toCell.transform = CGAffineTransformIdentity;
        }
    };
    if (animate) {
...
- (void)transitionFromCell:(UICollectionViewCell<TYTabPagerBarCellProtocol> *)fromCell toCell:(UICollectionViewCell<TYTabPagerBarCellProtocol> *)toCell progress:(CGFloat)progress {
    ...
    fromCell.titleLabel1.textColor = [UIColor colorWithRed:selR+detalR*progress green:selG+detalG*progress blue:selB+detalB*progress alpha:selA+detalA*progress];
    toCell.titleLabel1.textColor = [UIColor colorWithRed:narR-detalR*progress green:narG-detalG*progress blue:narB-detalB*progress alpha:narA-detalA*progress];
}
