...
@interface ZMTabPagerView ()<ZMTabPagerBarDataSource,ZMTabPagerBarDelegate,TYPagerViewDataSource, TYPagerViewDelegate>
...
- (void)addTabBar {
    ZMTabPagerBar *tabBar = [[ZMTabPagerBar alloc]initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.frame), _tabBarHeight)];
