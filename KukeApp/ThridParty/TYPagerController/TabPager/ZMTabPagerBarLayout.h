...
#import "ZMTabPagerBarCell.h"

NS_ASSUME_NONNULL_BEGIN

typedef NS_ENUM(NSUInteger, ZMPagerBarStyle) {
    ZMPagerBarStyleNoneView,
    ZMPagerBarStyleProgressView,
    ZMPagerBarStyleProgressBounceView,
    ZMPagerBarStyleProgressElasticView,
    ZMPagerBarStyleCoverView,
};

@class ZMTabPagerBar;
@interface ZMTabPagerBarLayout : NSObject

@property (nonatomic, weak, readonly) ZMTabPagerBar *pagerTabBar;
...
@property (nonatomic, assign) ZMPagerBarStyle barStyle; // default TYPagerBarStyleProgressElasticView
...
- (instancetype)initWithPagerTabBar:(ZMTabPagerBar *)pagerTabBar NS_DESIGNATED_INITIALIZER;
...
// override
- (void)transitionFromCell:(UICollectionViewCell<ZMTabPagerBarCellProtocol> *_Nullable)fromCell toCell:(UICollectionViewCell<ZMTabPagerBarCellProtocol> *_Nullable)toCell animate:(BOOL)animate;

- (void)transitionFromCell:(UICollectionViewCell<ZMTabPagerBarCellProtocol> *_Nullable)fromCell toCell:(UICollectionViewCell<ZMTabPagerBarCellProtocol> *_Nullable)toCell progress:(CGFloat)progress;
